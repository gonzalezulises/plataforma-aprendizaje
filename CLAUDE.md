...
This command **requires** the project directory as an argument via `C:\Users\gonza\claude-projects`.

**Example:** `/create-spec generations/my-app`

**Output location:** `C:\Users\gonza\claude-projects/prompts/app_spec.txt` and `C:\Users\gonza\claude-projects/prompts/initializer_prompt.md`

If `C:\Users\gonza\claude-projects` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `C:\Users\gonza\claude-projects/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `C:\Users\gonza\claude-projects/prompts/app_spec.txt`
...
**Output path:** `C:\Users\gonza\claude-projects/prompts/initializer_prompt.md`
...
**Output path:** `C:\Users\gonza\claude-projects/prompts/.spec_status.json`
...
> "Your specification files have been created in `C:\Users\gonza\claude-projects/prompts/`!
>
> **Files created:**
> - `C:\Users\gonza\claude-projects/prompts/app_spec.txt`
> - `C:\Users\gonza\claude-projects/prompts/initializer_prompt.md`
>
